...
var Geosuggest = function (_React$Component) {
  ...
  function Geosuggest(props) {
    ...
    _this.onInputChange = function (userInput) {
      console.log('onInputChange', userInput)
      _this.setState({ userInput: userInput })
      _this.onAfterInputChange();
    };

    _this.onAfterInputChange = function () {
      console.log('onAfterInputChange')
      if (!_this.state.isSuggestsHidden) {
        console.log('onAfterInputChange state:' , _this.state.isSuggestsHidden)
        _this.showSuggests();
      }
      //_this.showSuggests();
      _this.props.onChange(_this.state.userInput);
      //_this.searchSuggests()
    ...
    _this.onSuggestNoResults = function () {
      console.log('onSuggestNoResults')
  ...
  _createClass(Geosuggest, [{
    ...
    value: function searchSuggests() {
      var _this2 = this;
      console.log('searchSuggests', this.state, this.state.userInput)
      if (!this.state.userInput) {
        console.log('searchSuggests RETURNS')
        this.updateSuggests();
        return;
      }
      ...
      this.setState({ isLoading: true })
        ...
        _this2.autocompleteService.getPlacePredictions(options, function (suggestsGoogle) {
          console.log(2222, suggestsGoogle)
    ...
    value: function updateSuggests() {
      ...
      this.setState({ suggests: suggests, activeSuggest: activeSuggest } )
      callback();
    }
    ...
    value: function geocodeSuggest(suggest) {
      var _this4 = this;
      console.log('geocodeSuggest', suggest)
