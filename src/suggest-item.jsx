...
export default class SuggestItem extends React.Component {
  ...
  scrollIfNeeded() {
    const el = this.ref,
      ...
      overBottom =
        el.offsetTop - parent.offsetTop + el.clientHeight > parent.scrollTop + parent.clientHeight;
  ...
  render() {
    const { suggest } = this.props,
      classes = classnames(
        ...
        {
          [this.props.activeClassname]: this.props.activeClassname ? this.props.isActive : null
        }
      );
